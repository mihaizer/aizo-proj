...
def parse_args():
    ...
    parser.add_argument(
        "--input",
        default="results/research_data.csv",
...
def write_typst_fragment(path, records):
    lines = [
...
def print_cli_report(records, analysis_dir, plots_dir, typst_path):
    ...
    print("  - 1750 data rows")
    print("  - 35 task blocks")
...
def main():
    ...
    write_typst_fragment(typst_path, records)
    print_cli_report(records, analysis_dir, plots_dir, typst_path)
